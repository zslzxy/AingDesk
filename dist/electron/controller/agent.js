...
class AgentController {
    constructor() {
        this.agentPath = path_1.default.resolve(public_1.pub.get_data_path(), 'agent');
        this.systemAgentPath = path_1.default.resolve(public_1.pub.get_resource_path(), 'agent');
    ...
    read_agent_config(agent_name) {
        ...
        if (public_1.pub.file_exists(agentConfigFile)) {
            try {
                ...
                ee_core_adapter_1.logger.error(public_1.pub.lang('读取智能体配置文件失败'), e);
                return null;
            }
        }
