    ...
    async get_model_manager() {
        ...
        if (version) {
            ...
            if (!await ollamaService.is_running()) {
                ee_core_adapter_1.logger.warn(public_1.pub.lang("Ollama 服务未启动，正在尝试启动..."));
                if (!await ollamaService.start()) {
                    ee_core_adapter_1.logger.warn(public_1.pub.lang("Ollama 服务启动失败"));
                }
            }
        }
        // 构建模型管理器信息对象
        ...
        try {
            ...
            if (configurationInfo.os_type === 'Windows_NT') {
                ...
                try {
                    ...
                    ee_core_adapter_1.logger.error(public_1.pub.lang('获取 Windows 系统信息时出错:'), error);
                }
            }
                ...
                try {
                    ...
                    ee_core_adapter_1.logger.error(public_1.pub.lang('获取 Linux 系统信息时出错:'), error);
                }
            }
                ...
                try {
                    ...
                    ee_core_adapter_1.logger.error(public_1.pub.lang('获取 MacOS 系统信息时出错:'), error);
                }
            }
            // 获取 GPU 信息
            try {
                ...
                ee_core_adapter_1.logger.error(public_1.pub.lang('获取 GPU 信息时出错:'), error);
            }
            ...
            ee_core_adapter_1.logger.error(public_1.pub.lang('获取配置信息时出现未知错误:'), error);
    ...
    async get_disk_list() {
        ...
        if (public_1.pub.is_windows()) {
            try {
                ...
                ee_core_adapter_1.logger.error(public_1.pub.lang('获取 Windows 磁盘信息时出错:'), error);
            }
        }
            ...
            try {
                ...
                ee_core_adapter_1.logger.error(public_1.pub.lang('获取 Linux 磁盘信息时出错:'), error);
            }
        }
            ...
            try {
                ...
                ee_core_adapter_1.logger.error(public_1.pub.lang('获取 macOS 磁盘信息时出错:'), error);
            }
        }
        return diskList;
    }
