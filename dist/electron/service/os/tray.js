...
class TrayService {
     ...
     */
    create() {
        ee_core_adapter_2.logger.info('[tray] load');
        const cfg = this.config;
        const mainWindow = (0, ee_core_adapter_3.getMainWindow)();
        // tray icon
        const iconPath = path_1.default.join((0, ee_core_adapter_1.getBaseDir)(), cfg.icon);
        // Tray menu items
