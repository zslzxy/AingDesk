...
class ShareChatService {
    ...
    readJsonFile(filePath) {
        try {
            ...
            ee_core_adapter_1.logger.error(`解析 JSON 文件 ${filePath} 时出错:`, error);
            return [];
        }
    }
    /**
    ...
    create_chat(shareId, title = "") {
        ...
        ee_core_adapter_1.logger.info('create_chat', { shareId, title });
    ...
    delete_chat(shareId, contextId) {
        ...
        try {
            ...
            ee_core_adapter_1.logger.error(`删除对话 ${contextId} 时出错:`, error);
        }
    }
    /**
     * 更新指定对话的标题
